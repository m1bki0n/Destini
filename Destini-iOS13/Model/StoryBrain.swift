...
struct StoryBrain {
    ...
    mutating func nextStory(_ userAnswer: String) {
        ...
        //The "userAnswer" will be equal to the button's label.
        
        if userAnswer == story[numOfStory].choice1 {
            numOfStory = story[numOfStory].choice1Destination
        } else {
            numOfStory = story[numOfStory].choice2Destination
        }
